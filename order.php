      ...
      <div style="display:none;" id="main" class="animate-bottom">
        ...
        <div class=header>
          <center><br><br><br><br><br>
            <font size="7" face="quicksand">
            ARE YOU A PRIME MEMBER OF CYBERCRAFT?<BR>NOT YET?<br>SIGN UP NOW AND GRAB ATTRACTIVE OFFERS...</font><BR><BR>
          <A HREF="signup.php"><button class=buttonheader>SIGN UP</button></a><br><br>
            <font size=3>I'm a prime member&nbsp;&nbsp;<a href="login.php">LOG IN</a></font>
        </div>
                  ...
                  <div class="row" style="padding:5px;">
                    <div class="col-sm-12"><br><br>
                        <center>By clicking on the button "Request Tender", You certifies you accept <a href="#"><font color=red>Terms and Conditions</font></a> of CyberCraft<br>
                          <input type="submit" id=button name="proceed" value="Proceed">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
